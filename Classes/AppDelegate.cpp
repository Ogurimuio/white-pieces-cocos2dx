...
bool AppDelegate::applicationDidFinishLaunching() {
...
#endif
		//glview->setFrameSize(360.0, 600.0);
        director->setOpenGLView(glview);
		//glview->setDesignResolutionSize(360.0, 600.0, ResolutionPolicy::FIXED_HEIGHT);
    ...
    //这里auto scene = HelloWorld::createScene();
	...
	//glview->setFrameSize(360.0f, 600.0f);
